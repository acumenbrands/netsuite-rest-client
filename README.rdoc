...
upsert
	...
	Return:
		...
		record paired with the parameters hash used to create or update the record. In the vent of an error, the id will be replaced by the exception caught upon write.
